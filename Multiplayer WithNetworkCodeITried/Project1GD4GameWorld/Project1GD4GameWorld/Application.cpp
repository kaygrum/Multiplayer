...
void Application::registerStates()
{
	...
	mStateStack.registerState<MultiplayerGameState>(StateIDs::HostGame, true);
	mStateStack.registerState<MultiplayerGameState>(StateIDs::JoinGame, false);
	mStateStack.registerState<PauseState>(StateIDs::Pause);
	mStateStack.registerState<PauseState>(StateIDs::NetworkPause, true);
	mStateStack.registerState<SettingsState>(StateIDs::Settings);
	mStateStack.registerState<GameOverState>(StateIDs::GameOver);
	mStateStack.registerState <LeaderBoardState> (StateIDs::LeaderBoard);
}
